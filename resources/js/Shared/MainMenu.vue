<template>
  <div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" :href="route('admin.jobs.index')">
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" :href="route('admin.companies.index')">
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" :href="route('admin.types.index')">
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" :href="route('admin.cities.index')">
        ...
        <div :class="isUrl('reports') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Cities</div>
      </Link>
    </div>
  </div>
</template>
