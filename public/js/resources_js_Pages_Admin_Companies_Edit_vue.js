...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/Object.assign(__default__, {
  ...
  setup: function setup(__props, _ref) {
    var _props$company$city, _props$company$data, _props$company$data2;
    ...
    var schema = yup__WEBPACK_IMPORTED_MODULE_0__.object({
      ...
      address: yup__WEBPACK_IMPORTED_MODULE_0__.object().nullable()
    });
    ...
    var _useField2 = (0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.useField)('vat', null, {
      initialValue: props.company.VAT
    }),
        vat = _useField2.value,
        vatError = _useField2.errorMessage;

    var _useField3 = (0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.useField)('city', null, {
      initialValue: (_props$company$city = props.company.city) === null || _props$company$city === void 0 ? void 0 : _props$company$city.name
    }),
        city = _useField3.value,
        cityError = _useField3.errorMessage;

    var _useField4 = (0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.useField)('street', null, {
      initialValue: (_props$company$data = props.company.data) === null || _props$company$data === void 0 ? void 0 : _props$company$data.street
    }),
        street = _useField4.value,
        streetError = _useField4.errorMessage;

    var _useField5 = (0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.useField)('number', null, {
      initialValue: (_props$company$data2 = props.company.data) === null || _props$company$data2 === void 0 ? void 0 : _props$company$data2.number
    }),
        number = _useField5.value,
        numberError = _useField5.errorMessage;

    var submit = handleSubmit(function (values) {
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia.post(route('admin.companies.update', {
    ...
    var deleteCompany = function deleteCompany() {
      sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
        ...
        if (result) {
          _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia["delete"](route('admin.companies.destroy', {
            companyId: props.company.id
          }));
        }
      });
...
var _hoisted_2 = {
  "class": "mt-8 pt-8 sm:mx-auto sm:w-full w-full"
};
var _hoisted_3 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.street]]), $setup.streetError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.streetError), 1
  /* TEXT */
  )) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_hoisted_13, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.number]]), $setup.numberError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_15, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.numberError), 1
  /* TEXT */
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $setup.city]])]), $setup.cityError ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_18, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.cityError), 1
  /* TEXT */
